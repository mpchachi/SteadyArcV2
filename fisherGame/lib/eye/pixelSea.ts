// Ported from eyetracker/pixelSea.js — SMB1 underwater background used during calibration.
...
export interface PixelSea {
  show:   () => void;
  hide:   () => void;
  remove: () => void;
}

export function createPixelSea(): PixelSea {
