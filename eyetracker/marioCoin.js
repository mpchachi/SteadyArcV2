...
function coinFrame3q(flip = false) {
...
export function createCoinElement(size = 64) {
  if (!document.getElementById('mario-coin-style')) {
    const style = document.createElement('style');
    style.id = 'mario-coin-style';
    style.textContent = `
      @keyframes marioCoinFrame0 {
        0%, 24.99%  { opacity: 1; }
        25%, 100%   { opacity: 0; }
      }
      @keyframes marioCoinFrame1 {
        0%, 24.99%  { opacity: 0; }
        25%, 49.99% { opacity: 1; }
        50%, 100%   { opacity: 0; }
      }
      @keyframes marioCoinFrame2 {
        0%, 49.99%  { opacity: 0; }
        50%, 74.99% { opacity: 1; }
        75%, 100%   { opacity: 0; }
      }
      @keyframes marioCoinFrame3 {
        0%, 74.99%  { opacity: 0; }
        75%, 100%   { opacity: 1; }
      }
    `;
